<div class="alert alert-success" role="alert">
	<h5 class="text-center text-uppercase font-weight-bold">setting pembayaran SPP <br><?= $header['tahun_ajaran'] ?></h5>
</div>
		...
		<div class="card">
			<div class="card-body">
				<h5 class="text-uppercase">
					<a class="btn btn-primary btn-sm font-weight-bold" href="<?= base_url() ?>Setting/setting_spp">Kembali</a>
				</h5>
			</div>
		</div>
	</div>
