...
<div class="row">
    <div class="col-md">
        <div class="card">
            <div class="card-body">
                <a class="btn btn-success btn-sm text-uppercase font-weight-bold" href="<?= base_url() ?>Laporan_spp/rekap_spp_kelas">Kembali Kelas</a>
            </div>
        </div>
    </div>
</div>
                        ...
                        ?>
                            ...
                            <td>
                                <h5 class="text-center">
                                    <a href="<?= base_url() ?>Laporan_spp/print_perkelas_pembayaran_spp/<?= $row['kelas_tahun_ajaran']; ?>" class="btn btn-danger btn-sm text-uppercase font-weight-bold" target="_blank"><i class="fas fa-print"></i> Print</a>
                                </h5>
                            </td>
                    </tr>
                <?php } ?>
