    ...
    <div class="col-md">
        <div class="card">
            <div class="card-body bg-primary">
                <h5 class="text-white text-uppercase">Nama Siswa : <?= $header['nama_siswa'] ?></h5>
            </div>
        </div>
    </div>
</div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td>
                                        <h5 class="text-center"><a class="btn btn-success btn-sm" href="<?= base_url() ?>Dashboard/detail_pembayaran_spp/<?= $row['siswa_tahun_ajar'] ?>">Pembayaran</a></h5>
                                    </td>
                            </tr>
                        <?php } ?>
                        </tbody>
