...
<body>
				...
				<div class="col-md mt-4">
					<table class="table border">
						<tbody>
							...
							<tr>
								<td class="text-uppercase font-weight-bold">SPP Per-Hari</td>
								<td class="font-weight-bold text-uppercase">: <?= $header['hari'] ?> <?= $header['bulan'] ?> <?= $header['tahun'] ?></td>
							</tr>
	...
	<div class="row">
		<div class="col-md">
			<div class="card">
				<div class="card-body">
					<h5> JUMLAH PEMBAYARAN SPP Per Hari: <?= $hasil_rupiah = "Rp " . number_format($header['total_pembayarn'], 2, ',', '.') ?></h5>
				</div>
			</div>
		</div>
